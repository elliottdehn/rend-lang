...
struct Added        { member: Address, power: u64 }
struct PowerChanged { member: Address, from: u64, to: u64 }
struct Removed      { member: Address }
...
entry fn add(member: Address, power: u64) -> bool {
    ...
    powers[member] = power;
    emit Added { member: member, power: power };
    return true;
}
...
entry fn set_power(member: Address, power: u64) -> bool {
    ...
    powers[member] = power;
    emit PowerChanged { member: member, from: prev, to: power };
    return true;
}
